...
When opening issues, pull requests, or discussions, **never include**:

- API keys, tokens, or OAuth credentials
- Passwords or session cookies
- Private memories or personal conversation content
- Personal data (yours or anyone else's)
- Internal endpoints, infrastructure details, or anything not already public

GitHub issues and pull requests are **public**. If you accidentally post
something sensitive, delete it immediately and rotate any exposed credential.
