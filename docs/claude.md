...
other Vilix AI-connected tools. Claude's remote connectors and Claude Code have
separate setup paths. Documentation checked September 10, 2026.

## Claude web and desktop

You need a [Vilix AI account](https://vilix.ai/get-started) and access to Claude
...
3. Select **Connect**, sign in to Vilix AI, and approve access through OAuth.
...
Connectors → Add → Custom → Web**. Members then connect their own Vilix AI accounts.
...
Connect there first if the mobile controls are unavailable, then enable Vilix AI
in the mobile conversation under the same Claude and Vilix AI accounts.
...
- [Vilix AI's current setup selector](https://vilix.ai/get-started)
